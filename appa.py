'''appa.py implements a Brainf*ck derivative
...
# Per https://www.dabeaz.com/ply/ply.html,
# whitespace must use \s instead of a space.
t_INCREMENT = r'Yip\.\sYip\.'
t_DECREMENT = r'Yip!\sYip!'
t_SHIFT_LEFT = r'Yip\.\sYip\?'
t_SHIFT_RIGHT = r'Yip\?\sYip\.'
t_OUTPUT = r'Yip!\sYip\?'
t_INPUT = r'Yip\?\sYip!'
t_OPEN_LOOP = r'Yip!\sYip\.'
t_CLOSE_LOOP = r'Yip\.\sYip!'
...
# All classes defined to run Appa code
class Appa:
    "Holds the Appa source code until it's run"
    def __init__(self, source):
        self.source = source

    def run(self):
        "runs the Appa source code, using a finite size of data"
        self.data = [0] * 100
        self.location = 0
...
class Commands:
    "Defines a collection of the commands for Appa"
    def __init__(self):
        self.commands = []
...
class Command:
    "Defines a command for parsing a Appa file"
...
class Loop:
    "Defines a loop for the Appa program structure"
    ...
    def __str__(self):
        return 'Yip! Yip.' + str(self.commands) + 'Yip. Yip!'
...
if __name__ == "__main__":
    ...
    parser.add_argument("input", help="the input Appa file to run")
    parser.add_argument(
        "--save-generated",
        "-s",
